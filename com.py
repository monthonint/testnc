...
answertxt = open("answer.txt", "w")
answercsv = open("answer.csv", "w")
path = ""
if(os.path.isdir("./set1example")):
    path = "./set1example/"
else:
    os.mkdir("set1example")
    path = "./set1example/"
...
for filename in listfile:
    ...
    copyfilename = ('.').join(copyfilename.split('.')[:-1])
    #Read file image
    answertxt.write(copyfilename+" :: ")
    answercsv.write(copyfilename+",")
...
idList = open(path+'round2_set_1_quest.txt','r')
for line in idList:
